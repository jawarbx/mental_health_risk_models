...
# From here: https://github.com/itakurah/focal-loss-pytorch/blob/main/focal_loss.py

class FocalLoss(nn.Module):
    def __init__(self, gamma=2, alpha=None, reduction='mean', task_type='binary', num_classes=None, pos_weight=None):
        """
...
class BinaryFocalLossTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        ...
        labels = inputs.pop("labels")  # 0/1
        outputs = model(**inputs)
        logits = outputs.logits  # (batch, 1) or (batch,)
